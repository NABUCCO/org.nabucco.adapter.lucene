...
/**
 * IndexGeoServiceHandlerImpl
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
public class IndexGeoServiceHandlerImpl extends IndexGeoServiceHandler {

    private static final long serialVersionUID = 1L;

    @Override
    protected EmptyServiceMessage indexGeo(LuceneGeoIndexRq msg) throws LuceneException {
        ...
        try {
            connection = super.getResourceManager().getConnection(msg.getIndexName().getValue());
            connection.indexDocument(msg.getDocument(), msg.getLocation());
            ...
            super.getLogger().error(re, "Error indexing fulltext document on index '", index, "'.");
            throw new LuceneException("Error indexing fulltext document on index '" + index + "'.", re);
