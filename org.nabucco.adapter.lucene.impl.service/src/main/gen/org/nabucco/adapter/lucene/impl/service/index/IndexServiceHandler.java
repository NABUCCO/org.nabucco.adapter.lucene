...
/**
 * IndexServiceHandler<p/>Service for indexing the fulltext search<p/>
 *
 * @version 1.0
 * @author Nicolas Moser, PRODYNA AG, 2011-05-05
 */
public abstract class IndexServiceHandler extends ResourceServiceHandlerSupport implements ServiceHandler,
        ResourceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.adapter.lucene.impl.service.index.IndexServiceHandler";

    /** Constructs a new IndexServiceHandler instance. */
    public IndexServiceHandler() {
        super();
    }
     ...
     */
    protected ServiceResponse<EmptyServiceMessage> invoke(ServiceRequest<LuceneIndexRq> rq) throws LuceneException {
        ServiceResponse<EmptyServiceMessage> rs;
        EmptyServiceMessage msg;
        try {
            this.validateRequest(rq);
            this.setContext(rq.getContext());
            msg = this.index(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     *
     * @param msg the LuceneIndexRq.
     * @return the EmptyServiceMessage.
     * @throws LuceneException
     */
    protected abstract EmptyServiceMessage index(LuceneIndexRq msg) throws LuceneException;
