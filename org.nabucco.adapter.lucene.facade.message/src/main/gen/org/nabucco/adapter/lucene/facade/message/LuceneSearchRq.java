...
/**
 * LuceneSearchRq<p/>A message containing the search information.<p/>
 *
 * @version 1.0
 * @author Nicolas Moser, PRODYNA AG, 2011-02-21
 */
public class LuceneSearchRq extends ServiceMessageSupport implements ServiceMessage {
    ...
    /** Constructs a new LuceneSearchRq instance. */
    public LuceneSearchRq() {
        super();
        this.initDefaults();
    }
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(LuceneSearchRq.getPropertyDescriptor(QUERY), this.getQuery()));
        return properties;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final LuceneSearchRq other = ((LuceneSearchRq) obj);
        if ((this.query == null)) {
            if ((other.query != null))
                return false;
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(LuceneSearchRq.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(LuceneSearchRq.class).getAllProperties();
    }
}
